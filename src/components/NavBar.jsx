...
<div className="nav">
    ...
    <div className="row2">
        <div>
            <h2 className='h2'>State Average</h2>
        <Select/>         
                <h1>{avg}</h1>
            </div>
        </div><hr/>
